...
class BMPConsumer(multiprocessing.Process):
    ...
    def process_msg(self, msg):
        ...
        if msg.topic == 'openbmp.parsed.router':
            self.process_router_msg(m.getCollector_hash_id(), m.getContent())

        elif msg.topic == 'openbmp.bmp_raw':
            self.process_bmp_raw_msg(m.getCollector_hash_id(),
                                     m.getRouter_hash_id(), hdr.getRouterIp(), m.getContent())
