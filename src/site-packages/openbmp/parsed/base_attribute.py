"""openbmp.parsed.base_attribute class
...
class base_attribute:
    """ Format class for base attribute parsed messages
    ...
    def isAttomicAggregate(self):
        return True if self.VALUES[20] == '1' else False


    def isNexthopIPv4(self):
      return True if self.VALUES[21] == '1' else False
